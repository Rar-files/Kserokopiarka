...
namespace Zadanie1
{
    ...
    public class MultiFunctionalDevice : Copier, IFax, IPrinter, IScanner
    {
        ...
        // public new void Print(in IDocument document) => base.Print(in document);
        ...
        public void Fax(in IDocument document = null, string telNumber = null)
        {
            ...
            System.Console.WriteLine($"{DateTime.Today} Fax: Wysłano do adresata o numerze {telNumber} dokument: {documentFaxBufor.GetFileName()}.");
        }
    }
}
